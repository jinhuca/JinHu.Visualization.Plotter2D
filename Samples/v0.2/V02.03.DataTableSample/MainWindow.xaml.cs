...
namespace DataTableSample
{
  ...
  public partial class MainWindow : Window
  {
    ...
    private void Window_Loaded(object sender, RoutedEventArgs e)
    {
      ...
      data.AddMapping(ShapePointMarker.SizeProperty, row => 4 + 3 * (double)row["Sqrt"]);

      // Plot first graph
      plotter.AddLineGraph(data, new Pen(Brushes.Blue, 2), new CirclePointMarker(), new PenDescription("Sine"));
